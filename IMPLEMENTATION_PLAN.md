...
7. **Team-name reveal:** “…and TOGETHER they are…” final intro beat; all labels (zone bands, meter ends, phone headers) swap from Team A/B to the AI names and persist.
8. **Doodle crowd stands (S4):** rotating gallery spectators in the colosseum stands (subtle idle bob; never obscuring the battlefield).
